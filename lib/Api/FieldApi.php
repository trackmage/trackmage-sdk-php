...
class FieldApi
{
     ...
     *
     * @param  string $entity The entity you need fields for. For example, shipments or orders. The whole format is entity[.type[.subtype]], for example, workflows.webhook or workflows.integration.sfc (required)
