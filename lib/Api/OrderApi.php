...
class OrderApi
{
     ...
     * @throws \TrackMage\Client\Swagger\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TrackMage\Client\Swagger\Model\OrderGetOrdersGetOrderMetaGetOrderStatusForOrderGetAddress[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrderCollectionWithHttpInfo($orderId = null, $orderOrderNumber = null, $orderExternalSyncId = null, $orderSubtotal = null, $orderTotal = null, $orderCreatedAt = null, $orderUpdatedAt = null, $createdAtBefore = null, $createdAtStrictlyBefore = null, $createdAtAfter = null, $createdAtStrictlyAfter = null, $updatedAtBefore = null, $updatedAtStrictlyBefore = null, $updatedAtAfter = null, $updatedAtStrictlyAfter = null, $id = null, $id2 = null, $orderNumber = null, $externalSyncId = null, $externalSyncId2 = null, $externalSource = null, $externalSource2 = null, $status = null, $status2 = null, $orderType = null, $orderType2 = null, $subtotal = null, $subtotal2 = null, $total = null, $total2 = null, $subtotalBetween = null, $subtotalGt = null, $subtotalGte = null, $subtotalLt = null, $subtotalLte = null, $totalBetween = null, $totalGt = null, $totalGte = null, $totalLt = null, $totalLte = null, $page = null, $itemsPerPage = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\TrackMage\Client\Swagger\Model\OrderGetOrdersGetOrderMetaGetOrderStatusForOrderGetAddress[]' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = $responseBody->getContents();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\TrackMage\Client\Swagger\Model\OrderGetOrdersGetOrderMetaGetOrderStatusForOrderGetAddress[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\TrackMage\Client\Swagger\Model\OrderGetOrdersGetOrderMetaGetOrderStatusForOrderGetAddress[]';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TrackMage\Client\Swagger\Model\OrderGetOrdersGetOrderMetaGetOrderStatusForOrderGetAddress[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \TrackMage\Client\Swagger\Model\OrderPostOrderSetOrderMetaSetOrderStatusForOrderSetAddress $order The new Order resource (optional)
     *
     * @throws \TrackMage\Client\Swagger\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TrackMage\Client\Swagger\Model\OrderGetOrderGetOrderMetaGetOrderStatusForOrderGetAddress
     ...
     *
     * @param  string $id id (required)
     * @param  \TrackMage\Client\Swagger\Model\OrderPutOrderSetOrderMetaSetOrderStatusForOrderSetAddress $order The updated Order resource (optional)
     *
     * @throws \TrackMage\Client\Swagger\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TrackMage\Client\Swagger\Model\OrderGetOrderGetOrderMetaGetOrderStatusForOrderGetAddress
