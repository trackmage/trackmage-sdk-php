...
class CarrierApi
{
     ...
     * @return \TrackMage\Client\Swagger\Model\CarrierGetCarrier[]
     */
    public function getCarrierCollection()
    {
        list($response) = $this->getCarrierCollectionWithHttpInfo();
        return $response;
    }
     ...
     * @throws \TrackMage\Client\Swagger\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TrackMage\Client\Swagger\Model\CarrierGetCarrier[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getCarrierCollectionWithHttpInfo()
    {
        $request = $this->getCarrierCollectionRequest();
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\TrackMage\Client\Swagger\Model\CarrierGetCarrier[]' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\TrackMage\Client\Swagger\Model\CarrierGetCarrier[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\TrackMage\Client\Swagger\Model\CarrierGetCarrier[]';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TrackMage\Client\Swagger\Model\CarrierGetCarrier[]',
     ...
     */
    public function getCarrierCollectionAsync()
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCarrierCollectionAsyncWithHttpInfo()
    {
        $returnType = '\TrackMage\Client\Swagger\Model\CarrierGetCarrier[]';
        $request = $this->getCarrierCollectionRequest();
     ...
     */
    protected function getCarrierCollectionRequest()
    {
