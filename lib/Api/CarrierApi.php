...
class CarrierApi
{
     ...
     * @return \TrackMage\Client\Swagger\Model\Carrier[]
     */
     ...
     * @throws \TrackMage\Client\Swagger\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TrackMage\Client\Swagger\Model\Carrier[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getCarrierCollectionWithHttpInfo()
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\TrackMage\Client\Swagger\Model\Carrier[]' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\TrackMage\Client\Swagger\Model\Carrier[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\TrackMage\Client\Swagger\Model\Carrier[]';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TrackMage\Client\Swagger\Model\Carrier[]',
