...
class OauthClientApi
{
     ...
     * @throws \TrackMage\Client\Swagger\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TrackMage\Client\Swagger\Model\OauthClientGet[]
     */
    public function getOauthClientCollection($name = null, $page = null, $itemsPerPage = null)
    {
        list($response) = $this->getOauthClientCollectionWithHttpInfo($name, $page, $itemsPerPage);
        return $response;
    }
     ...
     * @throws \TrackMage\Client\Swagger\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TrackMage\Client\Swagger\Model\OauthClientGet[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getOauthClientCollectionWithHttpInfo($name = null, $page = null, $itemsPerPage = null)
    {
        $request = $this->getOauthClientCollectionRequest($name, $page, $itemsPerPage);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\TrackMage\Client\Swagger\Model\OauthClientGet[]' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\TrackMage\Client\Swagger\Model\OauthClientGet[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\TrackMage\Client\Swagger\Model\OauthClientGet[]';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TrackMage\Client\Swagger\Model\OauthClientGet[]',
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOauthClientCollectionAsync($name = null, $page = null, $itemsPerPage = null)
    {
        return $this->getOauthClientCollectionAsyncWithHttpInfo($name, $page, $itemsPerPage)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOauthClientCollectionAsyncWithHttpInfo($name = null, $page = null, $itemsPerPage = null)
    {
        $returnType = '\TrackMage\Client\Swagger\Model\OauthClientGet[]';
        $request = $this->getOauthClientCollectionRequest($name, $page, $itemsPerPage);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getOauthClientCollectionRequest($name = null, $page = null, $itemsPerPage = null)
    {
     ...
     *
     * @param  \TrackMage\Client\Swagger\Model\OauthClientPost $oauthClient The new OauthClient resource (optional)
     *
     * @throws \TrackMage\Client\Swagger\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TrackMage\Client\Swagger\Model\OauthClientGet
