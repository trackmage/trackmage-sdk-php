...
class WorkflowApi
{
     ...
     * @throws \TrackMage\Client\Swagger\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TrackMage\Client\Swagger\Model\WorkflowGetWorkflowsGetWorkflowMeta[]
     */
    public function getWorkflowCollection($type = null, $type2 = null, $period = null, $period2 = null, $orderCreatedAt = null, $page = null, $itemsPerPage = null)
    {
        list($response) = $this->getWorkflowCollectionWithHttpInfo($type, $type2, $period, $period2, $orderCreatedAt, $page, $itemsPerPage);
        return $response;
    }
     ...
     * @throws \TrackMage\Client\Swagger\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TrackMage\Client\Swagger\Model\WorkflowGetWorkflowsGetWorkflowMeta[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getWorkflowCollectionWithHttpInfo($type = null, $type2 = null, $period = null, $period2 = null, $orderCreatedAt = null, $page = null, $itemsPerPage = null)
    {
        $request = $this->getWorkflowCollectionRequest($type, $type2, $period, $period2, $orderCreatedAt, $page, $itemsPerPage);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\TrackMage\Client\Swagger\Model\WorkflowGetWorkflowsGetWorkflowMeta[]' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = $responseBody->getContents();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\TrackMage\Client\Swagger\Model\WorkflowGetWorkflowsGetWorkflowMeta[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\TrackMage\Client\Swagger\Model\WorkflowGetWorkflowsGetWorkflowMeta[]';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TrackMage\Client\Swagger\Model\WorkflowGetWorkflowsGetWorkflowMeta[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getWorkflowCollectionAsync($type = null, $type2 = null, $period = null, $period2 = null, $orderCreatedAt = null, $page = null, $itemsPerPage = null)
    {
        return $this->getWorkflowCollectionAsyncWithHttpInfo($type, $type2, $period, $period2, $orderCreatedAt, $page, $itemsPerPage)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getWorkflowCollectionAsyncWithHttpInfo($type = null, $type2 = null, $period = null, $period2 = null, $orderCreatedAt = null, $page = null, $itemsPerPage = null)
    {
        $returnType = '\TrackMage\Client\Swagger\Model\WorkflowGetWorkflowsGetWorkflowMeta[]';
        $request = $this->getWorkflowCollectionRequest($type, $type2, $period, $period2, $orderCreatedAt, $page, $itemsPerPage);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getWorkflowCollectionRequest($type = null, $type2 = null, $period = null, $period2 = null, $orderCreatedAt = null, $page = null, $itemsPerPage = null)
    {
     ...
     *
     * @param  \TrackMage\Client\Swagger\Model\WorkflowSetWorkflowSetWorkflowMetaSetIntegration $workflow The new Workflow resource (optional)
     *
     * @throws \TrackMage\Client\Swagger\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TrackMage\Client\Swagger\Model\WorkflowGetWorkflowGetWorkflowMeta
     ...
     *
     * @param  string $id id (required)
     * @param  \TrackMage\Client\Swagger\Model\WorkflowSetWorkflowSetWorkflowMetaSetIntegration $workflow The updated Workflow resource (optional)
     *
     * @throws \TrackMage\Client\Swagger\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TrackMage\Client\Swagger\Model\WorkflowGetWorkflowGetWorkflowMeta
