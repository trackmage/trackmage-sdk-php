...
/**
 * PageScrollGet Class Doc Comment
 *
 * @category Class
 * @package  TrackMage\Client\Swagger
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class PageScrollGet implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PageScroll-Get';
    ...
    {
        $this->container['scrollColor'] = isset($data['scrollColor']) ? $data['scrollColor'] : null;
     ...
     * @return string|null
     */
    public function getScrollColor()
    {
        return $this->container['scrollColor'];
    }

    /**
     * Sets scrollColor
     *
     * @param string|null $scrollColor scrollColor
     *
     * @return $this
     */
    public function setScrollColor($scrollColor)
    {
        $this->container['scrollColor'] = $scrollColor;
