...
/**
 * OrderGetOrderGetOrderMetaGetOrderStatusForOrder Class Doc Comment
 *
 * @category Class
 * @package  TrackMage\Client\Swagger
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class OrderGetOrderGetOrderMetaGetOrderStatusForOrder implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Order-getOrder_getOrderMeta_getOrderStatusForOrder';
    ...
    protected static $openAPITypes = [
        ...
        'status' => '\TrackMage\Client\Swagger\Model\OrderStatusGetOrderGetOrderMetaGetOrderStatusForOrder',
        'subtotal' => 'string',
        'total' => 'string',
        'address' => 'string',
        'orderType' => 'string',
     ...
     * Gets status
     *
     * @return \TrackMage\Client\Swagger\Model\OrderStatusGetOrderGetOrderMetaGetOrderStatusForOrder|null
     */
     ...
     * Sets status
     *
     * @param \TrackMage\Client\Swagger\Model\OrderStatusGetOrderGetOrderMetaGetOrderStatusForOrder|null $status status
     *
     * @return $this
     */
